    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-3xl relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-card rounded-full border-2 border-primary shadow-lg">
            <Sparkles className="w-4 h-4 text-primary" />
            <span className="text-sm font-medium tracking-wider uppercase">Your Result</span>
            <Sparkles className="w-4 h-4 text-primary" />
          </div>
        </div>

        {/* Main Result Card */}
        <div className="bg-card border-2 border-primary rounded-lg p-8 md:p-12 shadow-2xl mb-8">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-magenta to-cobalt rounded-full mb-6 shadow-lg">
              <Icon className="w-10 h-10 text-white" />
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-typewriter text-foreground mb-4 leading-tight">
              {era.name}
            </h1>
          ...
          <div className="text-center">
            <h3 className="text-2xl font-typewriter mb-4 text-foreground">
            ...
            <Button 
              size="lg"
              className="bg-gradient-to-r from-magenta to-cobalt text-white hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl text-lg px-8 py-6 group"
            >
